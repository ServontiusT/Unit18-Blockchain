...
# YOUR CODE HERE
sender_input_data = st.text_input("Please enter the Sender:")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver_input_data = st.text_input("Please enter the Receiver:")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
amount_input_data = st.text_input("Please enter the Amount:")
